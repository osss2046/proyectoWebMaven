        ...
        <div class="container-fluid h-100">
            <div class="row h-100">
                ...
                <div class="col-lg-3 profile-left">
                    ...
                    <p>Nickname: Lorem Ipsum</p>
                    <p>Correo: lorem@ipsum.com</p>
                    ...
                    <div class=" text-center">
                        ...
                        <a class="btn btn-outline-light" href="#" >Editar Perfil</a>
                    </div>
                </div>
                ...
                <div class="col-lg-9 profile-right">
                    <div class="pb-3 mb-3 border-bottom">
                        ...
                        <br>
                        <br>
                        <p class="col-lg-6 ">Añade una descripcion tuya</p>
                        <br>
                        <br>
                    </div>
                    <div class="pb-3 mb-3 border-bottom">
                        ...
                        <br>
                        <br>
                        <p class="col-lg-6 ">Agrega tus generos favoritos</p>
                        <br>
                        <br>
                    </div>
                    <div>
                        ...
                        <br>
                        <br>
                        <p class="col-lg-6 ">Describe tus preferencias a la hora de leer</p>
                        <br>
                        <br>
                    </div>
                </div>
